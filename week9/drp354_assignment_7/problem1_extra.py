...
def main(csv_filename, num, sTime, eTime):
  ...
  alp = .6
  histlist=plt.hist(x, nbin, normed=1, histtype='bar', color= colors,alpha = alp, label=agenName, stacked=False)
...
if __name__ == '__main__':
  ...
  parser.add_argument("start_time", type=str, help="enter start time in \"2013/06/01-24:00:00\" format")
  parser.add_argument("end_time",type=str,  help="enter end time in \"2013/06/01-24:00:00\" format")
