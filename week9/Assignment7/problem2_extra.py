...
if __name__ == '__main__':
  ...
  parser.add_argument("start_date", type=str, help="enter start time in \"06/01/2013-24:00:00\" format")
  parser.add_argument("end_date",type=str,  help="enter end time in \"06/01/2013-24:00:00\" format")
